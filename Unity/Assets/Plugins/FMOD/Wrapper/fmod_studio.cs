...
namespace Studio
{
    ...
    public class System : HandleBase
    {
        ...
        public RESULT getListenerAttributes(out ATTRIBUTES_3D attributes)
        {
            return FMOD_Studio_System_GetListenerAttributes(rawPtr, out attributes);
        }
        public RESULT setListenerAttributes(ATTRIBUTES_3D attributes)
        {
        ...
        [DllImport (STUDIO_VERSION.dll)]
        private static extern RESULT FMOD_Studio_System_SetListenerAttributes   (IntPtr studiosystem, ref ATTRIBUTES_3D attributes);
        [DllImport (STUDIO_VERSION.dll)]
